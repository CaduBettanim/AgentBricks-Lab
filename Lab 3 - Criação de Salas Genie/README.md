...
6. Clique em **Create**
7. Altere o nome da sala no canto superior para Genie Vendas `seu_database`. Exemplo: **Genie Vendas cbettanim**
8. Vá até **Configure** > **Instructions**. Em **General Instructions** cole o texto abaixo:
